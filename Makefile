...
clean:
	...
	rm -f $(HOME)/Documents/KiCAD/9.0/scripting/plugins/delete_track.py
	rm -f $(HOME)/Documents/KiCAD/9.0/scripting/plugins/delete_unlocked_track.py
	...
	rm -f $(HOME)/Documents/KiCAD/9.0/scripting/plugins/delete_track_icon.png
